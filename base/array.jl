...
# These are required to dispatch correctly to the fallback methods since the
# above are required to be defined for bootstrap
setindex!(A::Array, X::AbstractArray, I::AbstractVector{Bool}) = _setindex!(linearindexing(A), A, X, I)
setindex!(A::Array, x, I::AbstractVector{Bool}) = _setindex!(linearindexing(A), A, x, I)
